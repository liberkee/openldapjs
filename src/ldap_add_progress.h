#ifndef OPENLDAPJS_SRC_LDAP_ADD_PROGRESS_H_
#define OPENLDAPJS_SRC_LDAP_ADD_PROGRESS_H_
...
class LDAPAddProgress : public Nan::AsyncProgressWorker {
 ...
 public:
   ...
   **/
  LDAPAddProgress(Nan::Callback *callback, Nan::Callback *progress,
...
#endif  // OPENLDAPJS_SRC_LDAP_ADD_PROGRESS_H_
