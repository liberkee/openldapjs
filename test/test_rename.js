...
describe('Testing the rename functionalities', () => {
  ...
  it('should reject if control is not a valid control object', () => {
    return ldapAsyncWrap.rename(config.ldapRename.dnChange, config.ldapRename.newrdn,
  ...
  it('should reject if dn  incorrectly defined', () => {
    ...
    return ldapAsyncWrap.rename(incorrectDefinedDn, config.ldapRename.newrdn,
  ...
  it('should reject if dn doesn\'t exist ', () => {
    ...
    return ldapAsyncWrap.rename(existDn, config.ldapRename.newrdn, config.ldapRename.newparent,
      controlOperation)
      .then(() => {
        should.fail('should not have passed');
      })
  ...
  it('should rename the dn', () => { // this looks like an over complicated unit test
    const validEntry = [
    ...
    return ldapAsyncWrap.delete(`${config.ldapRename.newrdn},${config.ldapRename.newparent}`)
      .then(() => {
