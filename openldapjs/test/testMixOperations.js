...
describe('Testing the Compare functionalities', () => {
  ...
  it('should search and comparte 10 times sequential', (next) => {
          ...
          .then(() => {
            ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
              ...
              .then(() => {
                ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                  .then((result4) => {
                    should.deepEqual(result4, searchResult);
                  })
                  .then(() => {
                    ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                      .then((result5) => {
                        should.deepEqual(result5, searchResult);
                      })
                      .then(() => {
                        ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                          .then((result6) => {
                            should.deepEqual(result6, searchResult);
                          })
                          .then(() => {
                            ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                              .then((result7) => {
                              ...
                              .then(() => {
                                ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                                  .then((result8) => {
                                    should.deepEqual(result8, searchResult);
                                  })
                                  .then(() => {
                                    ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                                      .then((result9) => {
                                        should.deepEqual(result9, searchResult);
                                      })
                                      .then(() => {
                                        ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000')
                                          .then((result10) => {
                                            should.deepEqual(result10, searchResult);
                                          })
                                          .then(() => {
                                            ldapAsyncWrap.compare(dn, attr, val)
                                              .then((compareResult1) => {
                                                should.deepEqual(compareResult1, comparisonResTrue);
                                              })
                                              .then(() => {
                                                ldapAsyncWrap.compare(dn, attr, val)
                                                  .then((compareResult2) => {
                                                    should.deepEqual(compareResult2, comparisonResTrue);
                                                  })
                                                  .then(() => {
                                                    ldapAsyncWrap.compare(dn, attr, val)
                                                      .then((compareResult3) => {
                                                        should.deepEqual(compareResult3, comparisonResTrue);
                                                      })
                                                      .then(() => {
                                                        ldapAsyncWrap.compare(dn, attr, val)
                                                          .then((compareResult4) => {
                                                            should.deepEqual(compareResult4, comparisonResTrue);
                                                          })
                                                          .then(() => {
                                                            ldapAsyncWrap.compare(dn, attr, val)
                                                              .then((compareResult5) => {
                                                                should.deepEqual(compareResult5, comparisonResTrue);
                                                              })
                                                              .then(() => {
                                                                ldapAsyncWrap.compare(dn, attr, val)
                                                                  .then((compareResult6) => {
                                                                    should.deepEqual(compareResult6, comparisonResTrue);
                                                                  })
                                                                  .then(() => {
                                                                    ldapAsyncWrap.compare(dn, attr, val)
                                                                      .then((compareResult7) => {
                                                                        should.deepEqual(compareResult7, comparisonResTrue);
                                                                      })
                                                                      .then(() => {
                                                                        ldapAsyncWrap.compare(dn, attr, val)
                                                                          .then((compareResult8) => {
                                                                            should.deepEqual(compareResult8, comparisonResTrue);
                                                                          })
                                                                          .then(() => {
                                                                            ldapAsyncWrap.compare(dn, attr, val)
                                                                              .then((compareResult9) => {
                                                                                should.deepEqual(compareResult9, comparisonResTrue);
                                                                              })
                                                                              .then(() => {
                                                                                ldapAsyncWrap.compare(dn, attr, val)
                                                                                  .then((compareResult10) => {
                                                                                    should.deepEqual(compareResult10, comparisonResTrue);
                                                                                  })
                                                                                  .then(() => {
                                                                                    next();
                                                                                  });
  ...
  it('should search and compare 10 times each in parallel', (next) => {
    ...
    const search1 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search2 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search3 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search4 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search5 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search6 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search7 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search8 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search9 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    const search10 = ldapAsyncWrap.search(searchBase, 2, 'cn=newPointChild10000');
    ...
    Promise.all([search1, search2, search3, search4, search5, search6, search7, search8, search9, search10,
      compare1, compare2, compare3, compare4, compare5, compare6, compare7, compare8, compare9, compare10])
      .then((results) => {
