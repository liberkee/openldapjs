...
LDAPBindProgress::LDAPBindProgress(Callback *callback, Callback *progress, LDAP *ld, int msgID)
...
**/
  void LDAPBindProgress::Execute(const AsyncProgressWorker::ExecutionProgress &progress) {
